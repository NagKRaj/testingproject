...
class EanBarCodes:
   ...
   CharSetA =  {
                ...
                '\x10':8000, '\x11':81, '\x12':82, '\x13':83, '\x14':84, '\x15':85, '\x16':86, '\x17':87,
   ...
   CharSetB = {
                ...
                'p':8000, 'q':81, 'r':82, 's':83, 't':84, 'u':85, 'v':86, 'w':87,
   ...
   CharSetC = {
                ...
                '8000':8000, '81':81, '82':82, '83':83, '84':84, '85':85, '86':86, '87':87,
   ...
   ValueEncodings = {  0:'11011001100',  1:'11001101100',  2:'11001100110',
        ...
        78:'11000010100', 79:'10001111010', 8000:'10100111100',
   ...
   def getImage(self, value, height = 50, extension = "PNG", path="barcode/"):
...
def testImage():
   ...
   bar = Code128()
   bar.getImage("9782212110708",60,"gif")
   bar.getImage("978221211070",60,"png")
